...
const MainContainer = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-tr from-black flex flex-col justify-end text-white p-20 max-lg:p-12 max-md:p-8 max-sm:p-4">
